define(['recording', 'counters'], function(rec, counters) {
  ...
  function nameHandler(name) {
    ...
    switch (name) {
      ...
      case "claymore_kill":
        /*special*/
        if ((checkCached == true) && (temp.Rminekill == true)) {
          localStorage.setItem("recordingLayers", JSON.parse(localStorage.getItem("recordingLayers")) + 1);
          setTimeout(function() {
      ...
      case "kill_grenade":
        /*special*/
        if ((checkCached == true) && (temp.Rnade == 1) && (temp.Rkill == false)) {
          localStorage.setItem("recordingLayers", JSON.parse(localStorage.getItem("recordingLayers")) + 1);
          setTimeout(function() {
      ...
      case "grenade_kills_in_a_row_1":
        /*special*/
        if ((checkCached == true) && (temp.Rnade == 2)) {
          localStorage.setItem("recordingLayers", JSON.parse(localStorage.getItem("recordingLayers")) + 1);
          setTimeout(function() {
            before = before < 8000 ? 8000 : before;
            after = after < 3000 ? 3000 : after;
      ...
      case "grenade_kills_in_a_row_2":
        /*special*/
        if ((checkCached == true) && (temp.Rnade == 3)) {
          localStorage.setItem("recordingLayers", JSON.parse(localStorage.getItem("recordingLayers")) + 1);
          setTimeout(function() {
            before = before < 8000 ? 8000 : before;
            after = after < 3000 ? 3000 : after;
      ...
      case "grenade_kills_in_a_row_3":
        /*special*/
        if ((checkCached == true) && (temp.Rnade == 5)) {
          localStorage.setItem("recordingLayers", JSON.parse(localStorage.getItem("recordingLayers")) + 1);
          setTimeout(function() {
            before = before < 8000 ? 8000 : before;
            after = after < 3000 ? 3000 : after;
