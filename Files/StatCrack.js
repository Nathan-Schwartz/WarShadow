...
{"key":"extrastrong","HP":275,"RFProtection":"FALSE","Repel_shot":"FALSE","Repair_num":913,"Shop_name":"shared_vest_06"}];
	...
	return vests;	
		...
		document.getElementById("distance").onchange = function(){
			if(isNaN(parseInt(document.getElementById("distance").value))){
	...
	function graphIT() {
		...
		var options = {
			...
			hAxis: {
				title: 'Distance (m)',
				minValue:0,
				viewWindow: {max: parseInt(document.getElementById("distance").value)},
		...
		for(var i = 0; i < weaponArr.length; i++){
			...
			//	console.log(weaponArr[i].key); //.name				
				for(var iters = 0; iters < 100; iters++){
					...
					if(document.getElementById("selectGData").value == "Ddamage"){
						myA[iters][arrnum] = damageCalc(parseInt(weaponArr[i].Damage), parseInt(weaponArr[i].Min_damage), document.getElementById(attach).value, RFP, iters,parseInt(weaponArr[i].Min_range), weaponArr[i].Class, parseInt(weaponArr[i].Damage_reduc));
						//console.log(damageCalc(parseInt(weaponArr[i].Damage), parseInt(weaponArr[i].Min_damage), document.getElementById(attach).value, RFP, iters,parseInt(weaponArr[i].Min_range), weaponArr[i].Class, parseInt(weaponArr[i].Damage_reduc)));

					}else if(document.getElementById("selectGData").value == "DttkH"){
						myA[iters][arrnum] = TTKhead(parseInt(weaponArr[i].Damage), parseInt(weaponArr[i].Min_damage), document.getElementById(attach).value, RFP, iters,parseInt(weaponArr[i].Min_range), weaponArr[i].Class, parseInt(weaponArr[i].Damage_reduc), vestHP, Hdamage_reduc, weaponArr[i].Archetype, parseInt(weaponArr[i].RPM));
					
					}else if(document.getElementById("selectGData").value == "DntkH"){
						myA[iters][arrnum] = NTKhead(parseInt(weaponArr[i].Damage), parseInt(weaponArr[i].Min_damage), document.getElementById(attach).value, RFP, iters,parseInt(weaponArr[i].Min_range), weaponArr[i].Class, parseInt(weaponArr[i].Damage_reduc), vestHP, Hdamage_reduc, weaponArr[i].Archetype);					
					
					}else if(document.getElementById("selectGData").value == "DttkV"){
						myA[iters][arrnum] = TTKvest(parseInt(weaponArr[i].Damage), parseInt(weaponArr[i].Min_damage), document.getElementById(attach).value, RFP, iters,parseInt(weaponArr[i].Min_range), weaponArr[i].Class, parseInt(weaponArr[i].Damage_reduc), vestHP, Repelshot, parseInt(weaponArr[i].RPM));
					
					}else if(document.getElementById("selectGData").value == "DntkV"){
						myA[iters][arrnum] = NTKvest(parseInt(weaponArr[i].Damage), parseInt(weaponArr[i].Min_damage), document.getElementById(attach).value, RFP, iters,parseInt(weaponArr[i].Min_range), weaponArr[i].Class, parseInt(weaponArr[i].Damage_reduc), vestHP, Repelshot);
...
document.getElementById("weaponSelect1").onchange = function(){updateData(1,false);};
document.getElementById("weaponSelect2").onchange = function(){updateData(2,false);};
document.getElementById("weaponSelect3").onchange = function(){updateData(3,false);};
document.getElementById("weaponSelect4").onchange = function(){updateData(4,false);};
document.getElementById("weaponSelect5").onchange = function(){updateData(5,false);};


document.getElementById("attachmentSelect1").onchange = function(){updateData(1,false);};
document.getElementById("attachmentSelect2").onchange = function(){updateData(2,false);};
document.getElementById("attachmentSelect3").onchange = function(){updateData(3,false);};
document.getElementById("attachmentSelect4").onchange = function(){updateData(4,false);};
document.getElementById("attachmentSelect5").onchange = function(){updateData(5,false);};

document.getElementById("selectGData").onchange = function(){updateData(1, true);updateData(2, true);updateData(3, true);updateData(4, true);updateData(5, true);};
document.getElementById("enemyVest1").onchange = function(){updateData(1, true);updateData(2, true);updateData(3, true);updateData(4, true);updateData(5, true);};
document.getElementById("enemyHelmet1").onchange = function(){updateData(1, true);updateData(2, true);updateData(3, true);updateData(4, true);updateData(5, true);};
document.getElementById("distance").onchange = function(){updateData(1, true);updateData(2, true);updateData(3, true);updateData(4, true);updateData(5, true);};
